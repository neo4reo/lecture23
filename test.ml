...
let tuple_tests =
  [ t "tuple1" "(1, 2, 3, 4)" "(1, 2, 3, 4)"
  ; t "tuple_get0" "(1, 2, 3, 4)[0]" "1"
  ; t "tuple_get1" "(1, 2, 3, 4)[1]" "2"
  ; terr "tuple_get_low" "(1, 2, 3, 4)[(3 - 7)]" "index too small"
  ; terr "tuple_get_hi"  "(1, 2, 3, 4)[3+7]" "index too large"
  ; t "istuple" "istuple((1,2,3,4))" "true"
  ]
